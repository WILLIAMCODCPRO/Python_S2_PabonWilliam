...
for i in range(1,empleados + 1):
    ...
    totalSalariosBrutos = sueldoBruto + totalSalariosBrutos
    promedioSalarioBruto = (totalSalariosBrutos/i)
    totalDescuentoEPS = descuentoEPS + totalDescuentoEPS
    totalDescuentoPension = descuentoPension + totalDescuentoPension
    totalSalarioNeto = sueldoNeto + totalSalarioNeto
    promedioSalarioNeto = (totalSalarioNeto/i)
